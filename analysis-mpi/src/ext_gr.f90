...
contains
    subroutine main_routine()
        ...
        real(real64):: vx, vy, v2, factor, num_dens
        ...
        if (rank==0) then
            ...
            call normalize_gr(gr_gp_global, dr)
            call normalize_gr(gr_pp_global, dr)
            call normalize_gr(gr_gg_global, dr)
            ...
            do iy=1,gr_3d_len
                do ix=1,gr_3d_len 
                    ...
                    gr_3d_global(ix,iy) = (gr_3d_global(ix,iy) / sqrt(vx*vy)) / num_dens
                end do
            end do
