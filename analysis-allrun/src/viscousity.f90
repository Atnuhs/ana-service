...
contains
 subroutine generate_vis_from_run_vis(fst_run, lst_run)
        ...
        call aggregate_x_xsd('viscousity/viscousity', fst_run, lst_run)
    end subroutine


    subroutine generate_vis_from_gk_vis()
        use convergence_green_kubo_formula_mod
        character(100),parameter:: file_integ = 'GK_viscousity/integ_acf_stress_mean.txt'
        character(100),parameter:: file_conv = 'viscousity/viscousity_stress_mean.txt'
        character(100),parameter:: file_integ_lim = 'viscousity/integ_acf_stress_mean_lm.txt'
