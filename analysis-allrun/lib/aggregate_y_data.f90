...
contains
    ...
    subroutine read_y_file(file_data, y)
    ...
    subroutine aggregate_y_data(filename, fst_run, lst_run)
        ! intent
        ...
        do run=fst_run, lst_run
            ...
            call read_y_file(trim(file_data), data_all(run))
        end do
