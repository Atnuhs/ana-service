      ...
      OPEN(UNIT=3,FILE='acfstress_intr.dat',STATUS='replace')
      OPEN(UNIT=9,FILE='viscosity_intr.dat',STATUS='replace')
      OPEN(UNIT=10,FILE='integvisc_intr.dat',STATUS='replace')
...
*********************************************
  130 FORMAT(E13.4,4E13.5)
      ...
      do K=1,NRUN
       ...
       OPEN(UNIT=1,FILE='../run'//C1//'/str_intr.dat',STATUS='OLD')
        do I=1,NDATA
